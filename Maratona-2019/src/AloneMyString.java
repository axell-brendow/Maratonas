...
public class AloneMyString
{
    // ----------------------- CONSTANTES DA CLASSE
    
    public static final AloneMyString EMPTY = new AloneMyString();
    ...
    public AloneMyString(String str)
    {
        if (AloneArray.exists(str))
        {
            this.str = str;
        }
    }
    ...
    /**
     * Converte a {@code str} para um objeto {@link AloneMyString}
     * 
     * @param str string a ser convertida
     * 
     * @return Objeto {@link AloneMyString} equivalente de {@code str}.
     */
    
    public static AloneMyString convert(String str)
    {
        AloneMyString convertedStr = null;
        
        if (AloneArray.exists(str))
        {
            convertedStr = new AloneMyString(str);
        }
    ...
    public static String getFirstChar(String str)
    {
        ...
        if (AloneArray.exists(str) && str.length() > 0)
        {
    ...
    public static String removeCharAt(int index, String str)
    {
        ...
        if (AloneArray.exists(str))
        {
            ...
            if (!AloneArray.indexIsOutOfBounds(index, length))
            {
    ...
    public static int hasSubstringAt(int startIndex, String substring, String str)
    {
        ...
        if (AloneArray.exists(substring, str))
        {
            int substringLength = substring.length();
            int strLength = str.length();
            
            if (!AloneArray.rangeIsOutOfBounds(startIndex, substringLength, strLength) &&
    ...
    public static boolean matches(String regex, String reference)
    {
        ...
        if (AloneArray.exists(regex, reference))
        {
    ...
    public static boolean equalsCaseInsensitive(String str1, String str2)
    {
        ...
        if (AloneArray.exists(str1, str2))
        {
    ...
    public static String removePattern(String regex, String str)
    {
        ...
        if (AloneArray.exists(regex, str))
        {
    ...
    public static String removeSubstring(String substring, String str)
    {
        ...
        if (AloneArray.exists(substring))
        {
    ...
    {
        return AloneArray.exists(data) && /*data.charAt(0) != '.' &&*/ AloneMyString.countChars('.', data) <= 1;
    }
    ...
    public static boolean getboolean(String str)
    {
        ...
        return ( AloneArray.exists(bool) ? bool : false );
    }
    ...
    {
        boolean equals = AloneArray.exists(object);
    ...
    public AloneMyString getFirstChar()
    {
    ...
    public AloneMyString getLastChar()
    {
    ...
    public AloneMyString removeCharAt(int index)
    {
    ...
    public AloneMyString removeLastChar()
    {
    ...
    public AloneMyString removePattern(String regex)
    {
    ...
    public AloneMyString removeSubstring(String substring)
    {
    ...
    public AloneMyString removeAllWhiteSpaces()
    {
    ...
    public int compareTo(AloneMyString myStr)
    {
        int difference = Integer.MAX_VALUE;
        
        if (AloneArray.exists(myStr))
        {
    ...
    public AloneMyString prepend(String str)
    {
    ...
    public AloneMyString prepend(AloneMyString myStr)
    {
        return convert(myStr + get());
    }
    
    public AloneMyString substring(int startIndex, int substringLength)
    {
        AloneMyString mySubstring = null;
        
        if (!AloneArray.rangeIsOutOfBounds(startIndex, substringLength, length()))
        {
    ...
    public AloneMyString toUpperCase()
    {
        return convert( get().toUpperCase() );
    }
    
    public AloneMyString toLowerCase()
    {
        return convert( get().toLowerCase() );
    }
    
    public AloneMyString replace(char charToFind, char charToReplace)
    {
        return convert( get().replace("" + charToFind, "" + charToReplace) );
    }
    
    public AloneMyString replace(String strToFind, String strToReplace)
    {
        return convert( get().replace(strToFind, strToReplace) );
    }
    
    public AloneMyString[] split(String delimiterRegex)
    {
        AloneMyString[] myStrs = null;
        
        if (AloneArray.exists(delimiterRegex))
        {
            String[] splitedStrs = get().split(delimiterRegex);
            myStrs = new AloneMyString[splitedStrs.length];
